...
variable "allowed_cidrs" {
  description = "List of CIDR blocks allowed to access the ALB. Empty list = no inbound rules (you must add them manually or via allowed_cidrs). Use this to restrict access instead of opening 0.0.0.0/0."
  type        = list(string)
  default     = []
